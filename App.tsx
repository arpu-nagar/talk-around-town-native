  ...
  useEffect(() => {
    const showWelcomeMessage = () => {
      const message = Platform.select({
        ios: 'To provide you with the best experience, we need to:\n\n' +
        ...
        android: 'To provide you with the best experience, we need to:\n\n' +
                '1. Send you notifications about nearby points of interest\n' +
                '2. Access your location to detect when you\'re near points of interest\n\n' +
      ...
      Alert.alert(
        'Welcome!',
        message,
        [{ text: 'OK', onPress: () => console.log('User acknowledged permissions') }]
      );
    };
    ...
    const logStartupInfo = async () => {
      if (__DEV__) {
        ...
        console.log('Bundle ID:', Platform.select({
