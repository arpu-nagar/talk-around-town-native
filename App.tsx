...
const App: React.FC = () => {
  ...
  const [details, setDetails] = useState<Array<{title: string; desription: string; pinColor: string}>>([
    {
      title: 'Norman Hall',
  ...
  const addLocation = () => {
    ...
    if (newLocation) {
      ...
      setDetails([...details, {title: name, desription: description, pinColor: 'red'}]);
      setNewLocation(null);
      setName('');
      setDescription('');
    }
    ...
    <View style={styles.container}>
      ...
      <>
        ...
        {newLocation && (
          <>
            <View>
              <TextInput placeholder="Title" value={name} onChange={(e) => {
                setName(e.nativeEvent.text)
              }}/>
              <TextInput placeholder="Description" value={description} onChange={(e) => {
